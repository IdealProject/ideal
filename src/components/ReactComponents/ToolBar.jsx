  ...
  return (
    <div className="toolbar mb-4 p-2 border-b border-gray-300 flex flex-wrap items-center">
      ...
      <button
        ...
        title="Deshacer"
      >
        <span><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
